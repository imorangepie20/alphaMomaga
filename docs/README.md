...
This directory contains the structured project documentation for the real estate management application and related work.
...
- document key decisions and implementation history
- keep debugging and feature work grounded in the real system context
- maintain a clear record of what changed and why
- keep the system flow visible across business domains and engineering work
