...
export const reminders: Reminder[] = [
  { title: "Vacancy inspection — Oak Street", date: "Oct 8" },
  { title: "Lease renewal review — The Somerset", date: "Oct 12" },
  { title: "Rent collection follow-up — Maple Heights", date: "Oct 17" },
];
